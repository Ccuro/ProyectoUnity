...
public class FlyingDemon : Enemy
{
    ...
    void Think()
    {
        ...
        if (Mathf.Abs(distanceX) > 5f || Mathf.Abs(distanceY) > 1f) // �Ÿ��� �ֶ��� ����
            StartCoroutine("Chase", sightDir);
        else // �Ÿ��� ����ﶧ�� ���� ����
        {
            int pattern = Random.Range(0, 4); // 0 = ���׿�, 1, 2, 3 = �극��
    ...
    IEnumerator Chase(int dir)
    {
        ...
        while (moveTime > 0)
        {
            ...
            rigid.linearVelocity = moveDir * chaseSpeed;
    ...
    IEnumerator Breath()
    {
        ...
        int type = Random.Range(0, 2); // 0 = �����ϸ鼭 �극��, 1 = �¿� �ݺ��̵��ϸ� �극��
    ...
    IEnumerator Meteor()
    {
        ...
        int meteorCount = Random.Range(meteorMinNum, meteorMaxNum + 1); // ���׿� ������ �������� �̴´�
        ...
        for (int i = 0; i < meteorCount; i++)
        {
            ...
            meteor.GetComponent<Rigidbody2D>().linearVelocity = new Vector2(Random.Range(meteorSpeedMin, meteorSpeedMax) * sightDir, -Random.Range(meteorSpeedMin, meteorSpeedMax));
        }
