...
public class Stage0_2_Event2 : MonoBehaviour
{
    ...
    IEnumerator Cut1()
    {
        ...
        {
            laurence.GetComponent<Rigidbody2D>().linearVelocity = new Vector2(4, 0);
            yield return null;
        }

        laurence.GetComponent<Rigidbody2D>().linearVelocity = Vector2.zero;
    ...
    IEnumerator Cut2()
    {
        ...
        {
            iraff.GetComponent<Rigidbody2D>().linearVelocity = new Vector2(-2.5f, 0);
            yield return null;
        }

        iraff.GetComponent<Rigidbody2D>().linearVelocity = Vector2.zero;
