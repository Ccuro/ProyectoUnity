...
public class Stage1_2_Event : MonoBehaviour
{
    ...
    IEnumerator BulletsSpawn()
    {
        for (int i = 0; i < bullets.Length; i++)
        {
            ...
            bullets[i].GetComponent<Rigidbody2D>().linearVelocity = new Vector2(-1 * shotDirX[i], shotDirY[i]);
    ...
    IEnumerator Cut1()
    {
        ...
        gaiten.GetComponent<Rigidbody2D>().linearVelocity = Vector2.zero;
        ...
        {
            time -= Time.deltaTime;
            gaiten.GetComponent<Rigidbody2D>().linearVelocity = Vector2.left * 3f;
        ...
        while (time > 0)
        {
            ...
            if ((int)time % 2 == 0)
            {
                Player.instance.GetComponent<Rigidbody2D>().linearVelocity = Vector2.right * 0.03f;
                gaiten.GetComponent<Rigidbody2D>().linearVelocity = Vector2.right * 0.03f;
            }
            else
            {
                Player.instance.GetComponent<Rigidbody2D>().linearVelocity = Vector2.left * 0.03f;
                gaiten.GetComponent<Rigidbody2D>().linearVelocity = Vector2.left * 0.03f;
            }
        ...
        {
            time -= Time.deltaTime;
            gaiten.GetComponent<Rigidbody2D>().linearVelocity = Vector2.left * 1.5f;
    ...
    IEnumerator Cut2()
    {
        ...
        {
            time -= Time.deltaTime;
            Player.instance.GetComponent<Rigidbody2D>().linearVelocity = Vector2.right * 2f;
            yield return null;
        }

        Player.instance.GetComponent<Rigidbody2D>().linearVelocity = Vector2.zero;
        ...
        {
            time -= Time.deltaTime;
            Player.instance.GetComponent<Rigidbody2D>().linearVelocity = Vector2.right * 0.25f;
            gaiten.GetComponent<Rigidbody2D>().linearVelocity = Vector2.left * 1.55f;
            yield return null;
        }
